...
public interface OnPhotoEditorListener {
     ...
     */
    void onEditTextChangeListener(View rootView, String text, int colorCode, int gravity,TextData textData);
    ...
    void update(int width, int height, String status,int position);
}
