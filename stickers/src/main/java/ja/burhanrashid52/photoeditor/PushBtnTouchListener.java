    ...
    public boolean onTouch(View pushView, MotionEvent event) {
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
             ...
             /*   imgLP.leftMargin = lastImgLeft - ((newWidth - lastImgWidth) );
                imgLP.topMargin = lastImgTop - ((newHeight - lastImgHeight) );*/
                ...
                pushBtnLP.leftMargin = anglePoint.x - pushImgWidth / 2;
                pushBtnLP.topMargin = anglePoint.y - pushImgHeight / 2;
